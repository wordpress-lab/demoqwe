...
class CreatePmsAssignDeductionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pms_assign_deductions', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('pms_assign_deductions', function(Blueprint $table){
    ...
    {
        Schema::dropIfExists('pms_assign_deductions');
    }
}
