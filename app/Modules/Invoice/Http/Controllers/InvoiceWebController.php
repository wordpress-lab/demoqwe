...
public function show($id)
{
    ...
    return view('invoice::invoice.show', compact('invoice', 'invoice_entries', 'sub_total','invoices','payment_receive_entries','credit_receive_entries','excess_receive_entries','OrganizationProfile','invoice_discount_count'));
}catch (\Exception $exception){
