                                    ...
                                    @foreach($bills as $bill)
                                        <tr>
                                            ...
                                            <td class="uk-text-right" style="white-space:nowrap !important;">
                                                <a href="{{ route('bill_show', ['id' => $bill->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="View" class="material-icons">visibility</i></a>
                                                <a href="{{ route('bill_edit', ['id' => $bill->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="material-icons">&#xE254;</i></a>
