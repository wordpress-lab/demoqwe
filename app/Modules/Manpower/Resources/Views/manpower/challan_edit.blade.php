    ...
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            @endif
                ...
                {{--@endif--}}
            {!! Form::open(['url' => route('challan_update',$challan->id),'method' => 'POST','files' => true]) !!}
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Challan Edit</span></h2>
                            </div>
                        </div>
                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" name="challanNo" value="{!! $challan->challanNo !!}">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="invoice_date" value="{!! $challan->challanDate !!}" name="challanDate" data-uk-datepicker="{format:'DD-MM-YYYY'}" required>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" name="district" value="{!! $challan->district !!}">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" name="branch" value="{!! $challan->branch !!}">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" name="fromAddress" value="{!! $challan->fromAddress !!}">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" name="organizationAddress" value="{!! $challan->organizationAddress !!}">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" name="rate_1" value="{!! $challan->rate_1 !!}">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" name="rate_2" value="{!! $challan->rate_2 !!}">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" name="rate_3" value="{!! $challan->rate_3 !!}">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" name="quantity_1" value="{!! $challan->quantity_1 !!}">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" name="quantity_2" value="{!! $challan->quantity_2 !!}">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <label for="invoice_date">Select Quantity 3</label>
                                        <input class="md-input" type="text" name="quantity_3" value="{!! $challan->quantity_3 !!}">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" name="amount_bangla" value="{!! $challan->amount_bangla !!}">
                                    </div>
                                </div>
                                ...
                                {{--<div class="uk-grid" data-uk-grid-margin>--}}
                                    ...
                                    {{--<div class="uk-width-medium-2-5">--}}
                                        ...
                                        {{--<input class="md-input" type="text" name="comment" value="{!! $challan->comment !!}">--}}
                                    {{--</div>--}}
                                {{--</div>--}}
