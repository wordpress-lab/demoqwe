...
@section('title', 'Reference Report')
                    ...
                    <div class="md-card-toolbar hidden-print">
                        <div class="md-card-toolbar-actions hidden-print">
                            ...
                            <div class="uk-modal" id="coustom_setting_modal">
                                ...
                                {!! Form::open(['url' => 'recruitreport/reference-report', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            ...
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                <p style="line-height: 5px;" class="heading_b uk-text-success">Reference</p>
                            ...
                            <div id="list_table_left_parent" class="uk-width-1-1" style="font-size: 12px;">
                                ...
                                <table id="list_table_left">
                                    ...
                                    <tr class="uk-text-upper">
                                        ...
                                        <th style="font-size: 10px">Ref Name</th>
                                        <th style="font-size: 10px">Total Passenger</th>
                                    ...
                                    @foreach($recruit as $value)
                                        <tr>
                                            ...
                                            <td>
                                            <a class="md-btn md-btn-flat md-btn-small md-btn-flat-primary md-btn-wave waves-effect waves-button" href="{{ route('recrutereport_passenger_report' , $value->customer_id) }}">Passenger</a>
                                            <a class="md-btn md-btn-flat md-btn-small md-btn-flat-warning md-btn-wave waves-effect waves-button" href="{{ route('recrutereport_subreference_report' , ["id"=>$value->customer_id,"order"=>1]) }}">Subreference</a>
                                            </td>
                                        </tr>
