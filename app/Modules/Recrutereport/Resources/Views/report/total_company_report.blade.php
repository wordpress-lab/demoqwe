                    ...
                    <div class="md-card-toolbar hidden-print">
                        <div class="md-card-toolbar-actions hidden-print">
                            ...
                            <div class="uk-modal" id="coustom_setting_modal">
                                ...
                                {!! Form::open(['url' => 'recruitreport/total-visa-report', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            ...
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                <p style="line-height: 5px;" class="heading_b uk-text-success">Company</p>
                            ...
                            <div id="list_table_left_parent" class="uk-width-1-1" style="font-size: 12px;">
                                ...
                                <table id="list_table_left">
                                    ...
                                    <tr class="uk-text-upper">
                                        ...
                                        <th style="font-size: 10px">Free Visa</th>
                                        <th style="font-size: 10px">Contact Visa</th>
                                        <th style="font-size: 10px">Processing Visa</th>
                                        <th style="font-size: 10px; width: 10px;">Action</th>               
                                    </tr>
                                    </thead>
                                    <tbody  >
                                    <?php $i=1; ?>
                                    @foreach($visa as $value)
                                        <tr>
                                            <td>{!! $i++ !!}</td>
                                            <td><a href="{{ route('recrutereport_total_visa_find_report', [$value->company_id, date('Y-m-d', strtotime($start)) , date('Y-m-d', strtotime($end)) ]) }}">{!! $value->Company->name !!}</a></td>
                                            <td>{!! $value->free_visa !!}</td>
                                            <td>{!! $value->contact_visa !!}</td>
                                            <td>{!! $value->processing_visa !!}</td>
                                            <td>
                                            <a class="md-btn md-btn-flat md-btn-small md-btn-flat-primary md-btn-wave waves-effect waves-button" href="{{ route('recrutereport_total_visa_report_group_wise',$value->company_id) }}">Groupwise</a>
                                            <a class="md-btn md-btn-flat md-btn-small md-btn-flat-warning md-btn-wave waves-effect waves-button" href="{{ route('recrutereport_total_visa_report_visa_wise',$value->company_id) }}">Visa Numberwise</a>
                                            </td>
                                        </tr>
