...
@section('styles')
    <style>
        ...
        @media print {
            ...
            #list_table_left tr th:nth-child(8) {
                display: none;
            }
            #list_table_right tr th:nth-child(8) {
                display: none;
            }
            #list_table_left tr td:nth-child(8) {
                display: none;
            }
            #list_table_right tr td:nth-child(8) {
                display: none;
            }
                    ...
                    <div class="md-card-toolbar hidden-print">
                        <div class="md-card-toolbar-actions hidden-print">
                            ...
                            <div class="uk-modal" id="coustom_setting_modal">
                                ...
                                {!! Form::open(['url' => 'recruitreport/medical-slip-report', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            ...
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                <p style="line-height: 5px;" class="heading_b uk-text-success">Medical</p>
                            ...
                            <div id="list_table_left_parent" class="uk-width-1-1" style="font-size: 12px;">
                                ...
                                <table id="list_table_left">
                                    ...
                                    <tr class="uk-text-upper">
                                        ...
                                        <th style="font-size: 10px">Local Reference</th>
                                        ...
                                        <th style="font-size: 10px">Next Visit Date</th>
                                    ...
                                    @foreach($medical as $value)
                                        <tr>
                                            ...
                                            <td>{!! $value->paxId->customer["display_name"] !!}</td>
                                            ...
                                            @else
                                                <td></td>
                                            @endif
                                            <td>{!! $value->medical_report_date?date('d-m-Y', strtotime($value->medical_report_date)):''  !!}</td>
                                            <td>{!! $value->medical_visit_date?date('d-m-Y', strtotime($value->medical_visit_date)):''  !!}</td>
