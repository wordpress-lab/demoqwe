...
@section('title', 'Medical Slip Report')
                    ...
                    <div class="md-card-toolbar hidden-print">
                        <div class="md-card-toolbar-actions hidden-print">
                            ...
                            <div class="uk-modal" id="coustom_setting_modal">
                                ...
                                {!! Form::open(['url' => 'recruitreport/medical-slip-form-report', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            ...
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                <p style="line-height: 5px;" class="heading_b uk-text-success">Medical Slip Form Report</p>
                            ...
                            <div id="list_table_left_parent" class="uk-width-1-1" style="font-size: 12px;">
                                ...
                                <table id="list_table_left">
                                    ...
                                    <tr class="uk-text-upper">
                                        ...
                                        <th style="font-size: 10px">Passport Received</th>
                                        <th style="font-size: 10px">Passport Submitted</th>
                                    </tr>
                                    </thead>
                                    <tbody  >
                                    <?php
                                    ...
                                    @foreach($medical as $value)
                                        ...
                                        @foreach($value->medicalslipFromPax as $item)
                                            ...
                                            $ref .= $item->customer["display_name"];
                                            ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php $i=1; $j=count($value->gamca_received_submit)?>
                                                @foreach($value->gamca_received_submit as $item)



                                                    @if($item->received_status)
                                                          {!! $item->medicalslipFromPax->paxid.' ('.$item->created_at->format("d-m-Y").')' !!}
