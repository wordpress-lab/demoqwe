                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            ...
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                <p style="line-height: 5px;" class="heading_b uk-text-success">{{ $company_name }} Report</p>

                                <p style="line-height: 5px;" class="uk-text-small">Group Name: {{ $visa_group_id }}</p>
                            ...
                            <div id="list_table_left_parent" class="uk-width-1-1" style="font-size: 12px;">
                                ...
                                <table id="list_table_left">
                                    ...
                                    <tr class="uk-text-upper">
                                        ...
                                        <th style="font-size: 10px">Visa Type</th>
                                        <th style="font-size: 10px">Sub Visa Number</th>
                                        <th style="font-size: 10px">Register Serial</th>
                                    </tr>
                                    </thead>
                                    <tbody  >
                                    <?php $i=1; ?>
                                    @foreach($visa as $value)
                                        <tr>
                                            ...
                                            <td>
                                                @if($value->visa_category_id == '1')Free Visa
                                                @elseif($value->visa_category_id == '2')Contact Visa
                                                @elseif($value->visa_category_id == '3')Processing Visa
                                                @endif
                                            </td>
