                    ...
                    <div class="md-card-toolbar hidden-print">
                        <div class="md-card-toolbar-actions hidden-print">
                            ...
                            <div class="uk-modal" id="coustom_setting_modal">
                                ...
                                {!! Form::open(['url' => route('recrutereport_total_visa_report_search_visa_wise'), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                                    ...
                                    <input type="text" name="company_id" value="{{$company_name->id}}" hidden>
                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            ...
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                <p style="line-height: 5px;" class="heading_b uk-text-success">{{ $company_name->name }} Report</p>
                            ...
                            <div id="list_table_left_parent" class="uk-width-1-1" style="font-size: 12px;">
                                ...
                                <table id="list_table_left">
                                    ...
                                    <tr class="uk-text-upper">
                                        <th style="font-size: 10px">Visa Number</th>
                                    ...
                                    @foreach($visa as $value)
                                        <tr>
                                            <td><a href="{{ route('recrutereport_total_visa_find_report_visa_wise', [$value->visaNumber, $company_name->id, date('Y-m-d', strtotime($start)) , date('Y-m-d', strtotime($end)) ]) }}">{!! $value->visaNumber !!}</a></td>
