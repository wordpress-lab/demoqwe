...
@section('title', 'Visa Details Report')
                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            ...
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                <p style="line-height: 5px;" class="heading_b uk-text-success">Visa Details</p>
                                <p style="line-height: 5px;" class="uk-text-small">Visa Number: {{ $visa->visaNumber }}</p>
                            </div>
                        </div>
                        <div class="uk-grid" >
                            ...
                            <div id="list_table_left_parent" class="uk-width-1-1" style="font-size: 12px;">
                                ...
                                <table id="list_table_left">
                                    ...
                                    <tr class="uk-text-upper">
                                        ...
                                        <th style="font-size: 10px">Stamping Return Date</th>        
                                    </tr>
                                    </thead>
                                    <tbody  >
                                    <?php $i=1; ?>
                                    @foreach($visa_stamp as $value)
                                        <tr>
