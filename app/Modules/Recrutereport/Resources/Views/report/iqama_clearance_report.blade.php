...
@section('title', 'Iqama Clearance Report')
                    ...
                    <div class="md-card-toolbar hidden-print">
                        <div class="md-card-toolbar-actions hidden-print">
                            ...
                            <div class="uk-modal" id="coustom_setting_modal">
                                ...
                                {!! Form::open(['url' => 'recruitreport/iqama-clearance-report', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            ...
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                <p style="line-height: 5px;" class="heading_b uk-text-success">Iqama Clearance</p>
