                    ...
                    <div class="md-card-toolbar hidden-print">
                        <div class="md-card-toolbar-actions hidden-print">
                            ...
                            <div class="uk-modal" id="coustom_setting_modal">
                                ...
                                {!! Form::open(['url' => route('recrutereport_total_visa_report_search_group_wise'), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                            ...
                            <div id="list_table_left_parent" class="uk-width-1-1" style="font-size: 12px;">
                                ...
                                <table id="list_table_left">
                                    ...
                                    <tr class="uk-text-upper">
                                        <th style="font-size: 10px">Group Id</th>
                                    ...
                                    @foreach($visa as $value)
                                        <tr>
                                            <td><a href="{{ route('recrutereport_total_visa_find_report_group_wise', [$value->idNum, $company_name->id, date('Y-m-d', strtotime($start)) , date('Y-m-d', strtotime($end)) ]) }}">{!! $value->idNum !!}</a></td>
