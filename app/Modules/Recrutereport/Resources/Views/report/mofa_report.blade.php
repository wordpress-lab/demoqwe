                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            ...
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                <p style="line-height: 5px;" class="heading_b uk-text-success">Mofa</p>
                            ...
                            <div id="list_table_left_parent" class="uk-width-1-1" style="font-size: 12px;">
                                ...
                                <table id="list_table_left">
                                    ...
                                    <tr class="uk-text-upper">
                                        ...
                                        <th style="font-size: 10px">Mofa Number</th>
                                        <th style="font-size: 10px">Medical Submit Date</th>
                                    ...
                                    @foreach($medical as $value)
                                        <tr>
                                            ...
                                            <td>{!! $value->pax->passenger_name !!}</td>
                                            <td>{!! $value->pax->customer["display_name"] !!}</td>
                                            <td>{!! $value->mofaNumber !!}</td>
                                            <td>{!! $value->medical_submit_date !!}</td>
