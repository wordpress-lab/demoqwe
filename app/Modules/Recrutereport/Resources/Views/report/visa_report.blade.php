                    ...
                    <div class="md-card-toolbar hidden-print">
                        <div class="md-card-toolbar-actions hidden-print">
                            ...
                            <div class="uk-modal" id="coustom_setting_modal">
                                ...
                                {!! Form::open(['url' => 'recruitreport/visa-report', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            ...
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                <p style="line-height: 5px;" class="heading_b uk-text-success">Visa</p>
                            ...
                            <div id="list_table_left_parent" class="uk-width-1-1" style="font-size: 12px;">
                                ...
                                <table id="list_table_left">
                                    ...
                                    <tr class="uk-text-upper">
                                        ...
                                        <th style="font-size: 10px">ID Num</th>
                                        <th style="font-size: 10px">No of Visa</th>
                                        <th style="font-size: 10px">Left Visa</th>
                                        <th style="font-size: 10px">Date</th>
                                        <th style="font-size: 10px">Ref</th>



                                        <th style="font-size: 10px">Reg Serial</th>
                                    ...
                                    @foreach($medical as $value)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('recrutereport_visa_details' , $value->id) }}">{!! $value->visaNumber !!}</a></td>
                                            <td>{!! $value->idNum !!}</td>
