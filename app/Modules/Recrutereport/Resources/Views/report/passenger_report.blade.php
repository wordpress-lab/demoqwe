                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            ...
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                <p style="line-height: 5px;" class="heading_b uk-text-success">Passenger</p>
                                ...
                                <table id="list_table_left">
                                    ...
                                    @foreach($recruit as $value)
                                        <tr>
                                            ...
                                            <td>{!! $value->paxid !!}</td>
                                            <td>{!! $value->registerserial?$value->registerserial->Company['name']:'' !!}</td>
                                            <td>{!! $value->invoice['total_amount'] !!}</td>
                                            <td>{!! ($value->invoice['total_amount'] - $value->invoice['due_amount']) !!}</td>
