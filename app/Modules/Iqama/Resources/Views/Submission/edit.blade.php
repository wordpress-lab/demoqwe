...
@section('title', 'Edit Iqama Submission ')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Edit Iqama Submission</span></h2>
                            </div>
                        </div>
                        <div class="user_content">
                            <div class="uk-margin-top">
                                {!! Form::open(['url' => route('iqama_submission_update',$recruit->id), 'method' => 'POST', 'files' => true]) !!}
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <label for="date_of_payment">Date of Submission</label>
                                        <input value="{{ date("Y-m-d",strtotime($recruit->submission_date)) }}" required data-uk-datepicker="{format:'YYYY-MM-DD'}" class="md-input" type="text" id="submission_date" name="submission_date"/>
