        ...
        <div class="md-card">
            <div class="md-card-content">
                ...
                <a href="javascript::void(0);">
                    ...
                    <span class="uk-text-muted uk-text-small">Flight Date</span>
                </a>
            </div>
        </div>
    </div>
                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <div class="uk-width-medium-1-1" style="text-align: right;">
                                <a class="md-btn md-btn-primary md-btn-small md-btn-wave-light waves-effect waves-button waves-light md-bg-blue-grey-400" href="{{ route('confirmation',['id' => $count]) }}?all">Show All</a>
                                <a class="md-btn md-btn-primary md-btn-small md-btn-wave-light waves-effect waves-button waves-light md-bg-deep-orange-400" href="{{ route('confirmation') }}">Processing</a>
                            </div>
                                    ...
                                    @foreach($recruit as $value)
                                            <tr>
                                                ...
                                                <td class="uk-text-right" style="white-space:nowrap !important;">
                                                    ...
                                                    @if(count($value->confirmation['confirmationFile']))
                                                        <div class="uk-button-dropdown" data-uk-dropdown="{pos:'left-center'}">
                                                            ...
                                                            <div class="uk-dropdown">
                                                                <ul class="uk-nav uk-nav-dropdown">
                                                                    ...
                                                                    <hr/>
                                                                    @foreach($value->confirmation['confirmationFile'] as $file)
                                                                        <li>
                                                                            <a title="open file" style="text-transform: capitalize" target="_blank" href="{{ route('confirmation_file_download',$file->id?$file->id:0) }}">{{ trim($file->title) }}</a>
                                                ...
                                                @if($value->id == $value->confirmation['pax_id'])
                                                        <a href="{!! route('confirmation_edit',$value->id) !!}" class="batch-edit"><i class="md-icon material-icons ">&#xE254;</i></a>
                                                @else
                                                        <a href="{!! route('confirmation_create',$value->id) !!}" class="batch-edit"><i class="md-icon material-icons ">+</i></a>
                                                @endif

                                                @if(!empty($value->confirmation['bill_id']))
                                                <a href="{!! route('bill_show',$value->confirmation['bill_id']) !!}" class="batch-edit" title="Bill Show" data-uk-tooltip="{pos:'top'}"><i class="material-icons" style="color: green;font-size: 30px">B</i></a>
                                                @endif
                                                </td>
                                            </tr>
                                    @endforeach
