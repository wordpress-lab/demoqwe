        ...
        <div class="md-card">
            <div class="md-card-content">
                ...
                <a href="javascript::void(0);">
                    ...
                    <span class="uk-text-muted uk-text-small">Police Clearance Ok</span>
                </a>
            </div>
        </div>
    </div>
                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <div class="uk-width-medium-1-1" style="text-align: right;">
                                <a class="md-btn md-btn-primary md-btn-small md-btn-wave-light waves-effect waves-button waves-light md-bg-blue-grey-400" href="{{ route('police_clearance_index',['id' => $count]) }}?all">Show All</a>
                                <a class="md-btn md-btn-primary md-btn-small md-btn-wave-light waves-effect waves-button waves-light md-bg-deep-orange-400" href="{{ route('police_clearance_index') }}">Processing</a>
                            </div>
                                    ...
                                    @foreach($recruit as $value)
                                            <tr>
                                                ...
                                                <td class="uk-text-right" style="white-space:nowrap !important;">
                                                    @if( count($value->police['policeClearanceFile']))
                                                        <div class="uk-button-dropdown" data-uk-dropdown="{pos:'left-center'}">
                                                            ...
                                                            <div class="uk-dropdown">
                                                                <ul class="uk-nav uk-nav-dropdown">
                                                                    ...
                                                                    <hr/>
                                                                    @foreach($value->police['policeClearanceFile'] as $file)
                                                                        <li>
                                                                            <a title="open file" style="text-transform: capitalize" target="_blank" href="{{ route('police_clearence_download',$file->id?$file->id:0) }}">{{ trim($file->title) }}</a>
