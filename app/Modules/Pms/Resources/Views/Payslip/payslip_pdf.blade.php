                                ...
                                <div class="uk-width-1-1">
                                    <table id="table_center" border="1" class="uk-table"  >
                                        ...
                                        <tr class="uk-text-upper">
                                            ...
                                            Allowances</th>
                                            <th class="uk-text-center" colspan="2">Deductions</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                    ...
                                    <div style="height: 35px; width: 40%;  padding: 8px; border: 1px solid black"><b>Total Payable : {{ number_format($payslip->total_payable, 2, '.', '') }}</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Total Paid : {{ number_format($payslip->total_paid, 2, '.', '') }}</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Total Due : {{ number_format($payslip->total_due, 2, '.', '') }}</b></div>
                                </div>
                            </div>
