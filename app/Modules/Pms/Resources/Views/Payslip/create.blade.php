...
@section('title', 'Pms Payroll Payslip Create')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Create New Pms Payroll Payslip</span></h2>
                                <div class="uk-width-medium-1-3">
                                    <div class="md-btn-group">
                                        <a href="{{ route('pms_payroll_payslip_index') }}" class="md-btn md-btn-small md-btn-primary md-btn-wave">All</a>
                                        <a href="{{ route('pms_payroll_payslip_create') }}" class="md-btn md-btn-small md-btn-primary md-btn-wave">Add</a>
                        ...
                        <div class="md-card">
                            {!! Form::open(['url' => route('pms_payroll_payslip_store'), 'method' => 'POST','files' => true]) !!}
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="type">Select Payroll Sheet <span style="color: red;">*</span></label>
                                        </div>
