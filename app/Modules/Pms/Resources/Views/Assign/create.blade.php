...
@section('title', 'Leave Assign Create')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Create new sites assign</span></h2>
                            </div>
                        </div>
                        <div class="user_content">
                            <div class="uk-margin-top">
                                {!! Form::open(['url' => route('pms_leave_assign_store'), 'method' => 'POST', 'files' => true]) !!}
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5 uk-vertical-align">
                                        <label for="name" class="uk-vertical-align-middle">Employee</label>
                                    </div>
                                    <div class="uk-width-medium-2-5">
                                       <select id="pms_employee_id" class="md-input" name="pms_employee_id">
                                            <option value="">Select Employee...</option>
                                            @foreach($employee as $all)
                                            <option value="{{ $all->id }}">EMP-{{ $all->code_name }}</option>
                                            @endforeach
                                        </select>
                                        @if($errors->has('pms_employee_id'))
                                            <div class="uk-text-danger">{{ $errors->first('pms_employee_id') }}</div>
                                        @endif
                                    </div>
                                </div>
