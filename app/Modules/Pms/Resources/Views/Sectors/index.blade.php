                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <div class="uk-overflow-container uk-margin-bottom">
                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                    ...
                                    @foreach($sectors as $value)
                                        ...
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td>{{ $value->type==1?'Allowance':'Deduction' }}</td>
                                            <td>{{ $value->required==1?'Required':'Optional' }}</td>

                                            <td>{{ $value->name }}</td>

                                            <td class="uk-text-center" style="white-space:nowrap !important;">

                                                <a href="{{ route('pms_sectors_edit' , $value->id) }}">
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="{{ route('pms_sectors_create') }}" class="md-fab md-fab-accent branch-create">
    ...
    <script>
        ...
        $('.delete_btn').click(function () {
            ...
            swal({
                ...
                window.location.href = "{{ route('pms_sectors_destroy' , ['id' => '']) }}"+"/"+id;
            })
        })
    </script>
@endsection
