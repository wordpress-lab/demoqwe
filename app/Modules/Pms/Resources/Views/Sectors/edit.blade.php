...
@section('title', 'Pms Sectors Edit')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Edit Pms Sectors</span></h2>
                        ...
                        <div class="md-card">
                            {!! Form::open(['url' => route('pms_sectors_update' , $sector->id), 'method' => 'POST','files' => true]) !!}
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <select data-md-selectize name="type" id="type" class="md-input" data-uk-tooltip="{pos:'top'}" title="Select type">
                                                ...
                                                <option value="1" {{ $sector->type==1?'selected':'' }} >Allowance</option>
                                                <option value="0" {{ $sector->type==0?'selected':'' }}>Deduction</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="name" name="name" value="{{ $sector->name }}" />
                                        </div>
