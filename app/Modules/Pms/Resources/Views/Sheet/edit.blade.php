...
@section('title', 'Pms Payroll Sheet Edit')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Edit Pms Payroll Sheet</span></h2>
                        ...
                        <div class="md-card">
                            {!! Form::open(['url' => route('pms_payroll_sheet_update',$sheet->id), 'method' => 'POST','files' => true]) !!}
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="period_from" name="period_from" data-uk-datepicker="{format:'YYYY-MM-DD'}" value="{{$sheet->period_from}}"/>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <label for="nationality">Select Date</label>
                                            <input class="md-input" type="text" id="period_to" name="period_to" data-uk-datepicker="{format:'YYYY-MM-DD'}" value="{{$sheet->period_to}}"/>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <select data-md-selectize name="pms_sites_id" id="pms_sites_id" class="md-input" data-uk-tooltip="{pos:'top'}" title="Select Site">
                                                ...
                                                @foreach($site as $all)
                                                    <option value="{{ $all->id }}" {{ ($all->id==$sheet->pms_sites_id)?'selected':'' }}>{{ $all->company_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <select data-md-selectize name="pms_company_id" id="pms_company_id" class="md-input" data-uk-tooltip="{pos:'top'}" title="Select Company">
                                                ...
                                                @foreach($company as $all)
                                                    <option value="{{ $all->id }}" {{ ($all->id==$sheet->pms_company_id)?'selected':'' }}>{{ $all->name_en }}</option>
                                                @endforeach
                                            </select>
