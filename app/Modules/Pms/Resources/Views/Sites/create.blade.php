                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Create New Pms site</span></h2>
                        ...
                        <div class="md-card">
                            {!! Form::open(['url' => route('pms_sites_store'), 'method' => 'POST','files' => true]) !!}
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="company_name" name="company_name" value="{{old('company_name')}}" />
                                        </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <textarea name="address" cols="30" rows="4" class="md-input no_autosize">{{ old('address')}}</textarea>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="contact_person" name="contact_person" value="{{old('contact_person')}}" />
                                        </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="position" name="position" value="{{old('position')}}" />
                                        </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input onkeypress="numbervalidate()" class="md-input" type="text" id="wages_rate" name="wages_rate" value="{{old('wages_rate')}}" />
                                        </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="billing_period_from" name="billing_period_from" data-uk-datepicker="{format:'YYYY-MM-DD'}" value="{{old('billing_period_from')}}" />
                                        </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="billing_period_to" name="billing_period_to" data-uk-datepicker="{format:'YYYY-MM-DD'}" value="{{old('billing_period_to')}}" />
                                        </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <input class="md-input" type="text" id="bill_to"  name="bill_to" value="{{old('bill_to')}}" />
