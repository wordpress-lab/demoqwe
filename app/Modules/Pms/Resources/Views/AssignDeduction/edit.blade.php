...
@section('title', 'Pms Assign Deduction Edit')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Edit Pms Allowance</span></h2>
                                <div class="uk-width-medium-1-3">
                                    <div class="md-btn-group">
                                        <a href="{{ route('pms_assign_deduction_index') }}" class="md-btn md-btn-small md-btn-primary md-btn-wave">All</a>
                                        <a href="{{ route('pms_assign_deduction_create') }}" class="md-btn md-btn-small md-btn-primary md-btn-wave">Add</a>
                        ...
                        <div class="md-card">
                            {!! Form::open(['url' => route('pms_assign_deduction_update',$allowance->id), 'method' => 'POST','files' => true]) !!}
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="date" name="date" data-uk-datepicker="{format:'YYYY-MM-DD'}" value="{{$allowance->date}}"/>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <select data-md-selectize name="pms_employees_id" id="pms_employees_id" class="md-input" data-uk-tooltip="{pos:'top'}" title="Select Employee">
                                                ...
                                                @foreach($employee as $all)
                                                    <option value="{{ $all->id }}" {{ ($all->id==$allowance->pms_employees_id)?'selected':'' }}>EMP-{{ $all->code_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <select data-md-selectize name="pms_sectors_id" id="pms_sectors_id" class="md-input" data-uk-tooltip="{pos:'top'}" title="Select Employee">
                                                ...
                                                @foreach($sector as $all)
                                                    <option value="{{ $all->id }}" {{ ($all->id==$allowance->pms_sectors_id)?'selected':'' }}>{{ $all->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="number" id="amount" name="amount" value="{{$allowance->amount}}" step="0.01"/>
                                        </div>
...
@section('scripts')
    ...
    <script>
        ...
        $('#pms_assign_deduction').addClass('act_item');
