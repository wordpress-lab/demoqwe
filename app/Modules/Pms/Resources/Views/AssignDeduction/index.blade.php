...
@section('title', 'Pms Assign Deduction')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_avatar fileinput fileinput-new" data-provides="fileinput">
                                <h2 style="color:white" class="heading_b"><span class="uk-text-truncate">All PMS Assign Deduction</span></h2>
                        ...
                        <div class="user_content">
                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                    ...
                                    @foreach($allowance as $value)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $value->sectorId['name']}}</td>
                                            <td>{{ $value->amount}}</td>

                                            <td class="uk-text-center" style="white-space:nowrap !important;">

                                                <a href="{{ route('pms_assign_deduction_edit',$value->id) }}">
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="{{ route('pms_assign_deduction_create') }}" class="md-fab md-fab-accent branch-create">
    ...
    <script>
        ...
        $('.delete_btn').click(function () {
            ...
            swal({
                ...
                window.location.href = "{{ route('pms_assign_deduction_destroy' , ['id' => '']) }}"+"/"+id;
            })
        })
    </script>
@endsection
