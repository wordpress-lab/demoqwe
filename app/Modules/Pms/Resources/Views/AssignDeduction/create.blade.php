...
@section('title', 'Pms Assign Deduction Create')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Create New Pms Assign Deduction</span></h2>
                        ...
                        <div class="md-card">
                            {!! Form::open(['url' => route('pms_assign_deduction_store'), 'method' => 'POST','files' => true]) !!}
