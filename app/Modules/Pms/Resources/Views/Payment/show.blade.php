...
@section('title', 'Pms Payroll Payment Show')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_avatar fileinput fileinput-new" data-provides="fileinput">
                                <h2 style="color:white" class="heading_b"><span class="uk-text-truncate">PMS Payment Show</span></h2>
                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                    ...
                                    @foreach($payment as $value)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ 'PV-'.$value->number}}</td>
                                            <td>{{ $value->amount}}</td>

                                            <td class="uk-text-center" style="white-space:nowrap !important;">
                                                
                                                <a href="{{ route('pms_payroll_payment_edit',$value->id) }}">
    ...
    <script>
        ...
        $('.delete_btn').click(function () {
            ...
            swal({
                ...
                window.location.href = "{{ route('pms_payroll_payment_destroy' , ['id' => '']) }}"+"/"+id;
            })
        })
    </script>
@endsection
