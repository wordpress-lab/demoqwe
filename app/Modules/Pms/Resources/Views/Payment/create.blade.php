...
@section('title', 'Pms Payslip Payment')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Create New Pms Payslip Payment</span></h2>
                                <div class="uk-width-medium-1-3">
                                    <div class="md-btn-group">
                                        <a href="{{ route('pms_payroll_payslip_index') }}" class="md-btn md-btn-small md-btn-primary md-btn-wave">All</a>
                                        <a href="{{ route('pms_payroll_payment_create',$id) }}" class="md-btn md-btn-small md-btn-primary md-btn-wave">Add</a>
                        ...
                        <div class="md-card">
                            {!! Form::open(['url' => route('pms_payroll_payment_store'), 'method' => 'POST','files' => true,'onsubmit' => 'return valid();']) !!}
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <textarea class="md-input" type="text" id="note" name="note" step="0.01"/>{{ old('note') }}</textarea>
                                        </div>
                                    </div>

                                    <input type="text" name="pms_payslips_id" id="information" value="{{ $id }}" data-due_amount="{{$payslip_due_amount}}" hidden>
