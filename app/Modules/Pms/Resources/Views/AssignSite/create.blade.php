                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <div class="uk-margin-top">
                                {!! Form::open(['url' => route('pms_assign_sites_store'), 'method' => 'POST', 'files' => true]) !!}
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-3">
                                        ...
                                        <select required id="selec_adv_1" name="empcode[]" multiple>
                                            @foreach($emp as $item)
                                                <option value="{{ $item->id }}" >{{ $item->code_name }}</option>
                                            @endforeach
                                        </select>
                                        @if($errors->first('empcode'))
                                            <div class="uk-text-danger">Employee code is required.</div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <label for="date_of_payment">Site Name</label>
