...
@section('title', 'Pms Invoice Payment Receive')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Create New Pms Invoice Payment Receive</span></h2>
                                <div class="uk-width-medium-1-3">
                                    <div class="md-btn-group">
                                        <a href="{{ route('pms_invoice_index') }}" class="md-btn md-btn-small md-btn-primary md-btn-wave">All</a>
                                        <a href="{{ route('pms_invoice_payment_receive_create',$id) }}" class="md-btn md-btn-small md-btn-primary md-btn-wave">Add</a>
                        ...
                        <div class="md-card">
                            {!! Form::open(['url' => route('pms_invoice_payment_receive_store'), 'method' => 'POST','files' => true,'onsubmit' => 'return valid();']) !!}
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <input type="text" name="pms_invoices_id" id="information" value="{{ $id }}" data-due_amount="{{$invoice_due_amount}}" hidden>
