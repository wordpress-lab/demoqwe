                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Edit Pms Invoice Payment Receive</span></h2>
                            </div>
                        </div>
                        <div class="md-card">
                            {!! Form::open(['url' => route('pms_invoice_payment_receive_update',$payment->id), 'method' => 'POST','files' => true]) !!}
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <input type="text" id="information" data-due_amount="{{$payment->invoiceId['due_amount'] + $payment->amount}}" hidden>
