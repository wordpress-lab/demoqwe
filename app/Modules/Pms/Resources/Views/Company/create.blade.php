...
@section('title', 'Pms Payroll Company Create')
            ...
            <div class="uk-grid uk-grid-medium" data-uk-grid-margin>
                <div class="uk-width-xLarge-10-10 uk-width-large-10-10">
                    <div class="md-card">
                        ...
                        <div class="md-card">
                            {!! Form::open(['url' => route('pms_payroll_company_store'), 'method' => 'POST','files' => true,'enctype' => 'multipart/form-data']) !!}
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="name_en" name="name_en" value="{{old('name_en')}}"/>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="name_ar" name="name_ar" value="{{old('name_ar')}}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="bank_name" name="bank_name" value="{{old('bank_name')}}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="account_name" name="account_name" value="{{old('account_name')}}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="account_number" name="account_number" value="{{old('account_number')}}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="iban" name="iban" value="{{old('iban')}}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="person_name" name="person_name" value="{{old('person_name')}}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="person_contact" name="person_contact" value="{{old('person_contact')}}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <textarea class="md-input" type="text" id="address_en" name="address_en"/></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <textarea class="md-input" type="text" id="address_ar" name="address_ar"/></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <input class="md-input" type="file" id="logo_url" name="logo_url" value="{{old('logo_url')}}"/>
                                        </div>
                                    </div>
