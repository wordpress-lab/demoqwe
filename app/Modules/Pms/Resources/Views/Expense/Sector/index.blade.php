                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <div class="uk-overflow-container uk-margin-bottom">
                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                    ...
                                    @foreach($sectors as $value)
                                        ...
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td style="white-space:nowrap !important;">{{ $value->name }}</td>

                                            <td>{{ str_limit($value->note,150) }}</td>
                                            ...
                                            <td class="uk-text-right" style="white-space:nowrap !important;">
                                                ...
                                                <a href="{{ route('pms_expense_sector_edit', ['id' => $value->id]) }}">
                                                ...
                                                <input type="hidden" class="sites_id" value="{{ route('pms_expense_sector_destroy',["id"=>$value->id]) }}">
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="{{ route('pms_expense_sector_create') }}" class="md-fab md-fab-accent branch-create">
