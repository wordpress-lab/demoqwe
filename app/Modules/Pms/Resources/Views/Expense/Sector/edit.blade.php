...
@section('title', 'Edit Pms Expense Sector ')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Edit Pms Expense Sector</span></h2>
                        ...
                        <div class="md-card">
                            {!! Form::open(['url' => route('pms_expense_sector_update',["id"=>$sector->id]), 'method' => 'POST','files' => false]) !!}
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <textarea name="note" cols="30" rows="4" class="md-input no_autosize">{{ $sector->note }}</textarea>
                                            @if($errors->has('note'))
