                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Create New Pms Expense Payment</span></h2>
                                <div class="uk-width-medium-1-3">
                                    <div class="md-btn-group">
                                        <a href="{{ route('pms_expense_index') }}" class="md-btn md-btn-small md-btn-primary md-btn-wave">All</a>
                                        <a href="{{ route('pms_expense_payment_create',$id) }}" class="md-btn md-btn-small md-btn-primary md-btn-wave">Add</a>
                        ...
                        <div class="md-card">
                            {!! Form::open(['url' => route('pms_expense_payment_store'), 'method' => 'POST','files' => true,'onsubmit' => 'return valid();']) !!}
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <input type="text" name="pms_expenses_id" id="information" value="{{ $id }}" data-due_amount="{{$expense_due_amount}}" hidden>
