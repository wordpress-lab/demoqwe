...
@section('title', 'Pms Assign Allowance')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_avatar fileinput fileinput-new" data-provides="fileinput">
                                <h2 style="color:white" class="heading_b"><span class="uk-text-truncate">All PMS Assign Allowance</span></h2>
                        ...
                        <div class="user_content">
                                    ...
                                    @foreach($allowance as $value)
                                        ...
                                        <tr>
                                            ...
                                            <td class="uk-text-center" style="white-space:nowrap !important;">
                                                ...
                                                <a href="{{ route('pms_assign_allowance_edit',$value->id) }}">
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="{{ route('pms_assign_allowance_create') }}" class="md-fab md-fab-accent branch-create">
    ...
    <script>
        ...
        $('.delete_btn').click(function () {
            ...
            swal({
                ...
                window.location.href = "{{ route('pms_assign_allowance_destroy' , ['id' => '']) }}"+"/"+id;
            })
        })
    </script>
@endsection
