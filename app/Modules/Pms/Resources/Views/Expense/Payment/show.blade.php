...
@section('title', 'Pms Expense Payment Show')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_avatar fileinput fileinput-new" data-provides="fileinput">
                                <h2 style="color:white" class="heading_b"><span class="uk-text-truncate">PMS Expense Show</span></h2>
                                    ...
                                    @foreach($payment as $value)
                                        ...
                                        <tr>
                                            ...
                                            <td class="uk-text-center" style="white-space:nowrap !important;">
                                                ...
                                                <a href="{{ route('pms_expense_payment_edit',$value->id) }}">
    ...
    <script>
        ...
        $('.delete_btn').click(function () {
            ...
            swal({
                ...
                window.location.href = "{{ route('pms_expense_payment_destroy' , ['id' => '']) }}"+"/"+id;
            })
        })
    </script>
@endsection
