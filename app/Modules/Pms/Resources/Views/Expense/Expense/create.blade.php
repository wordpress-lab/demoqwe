...
@section('title', 'Pms Expense create')
            ...
            <div class="uk-grid uk-grid-medium" data-uk-grid-margin>
                <div class="uk-width-xLarge-10-10 uk-width-large-10-10">
                    <div class="md-card">
                        ...
                        <div class="md-card">
                            {!! Form::open(['url' => route('pms_expense_store'), 'method' => 'POST','files' => false]) !!}
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="amount" name="amount" value="{{old('amount')}}" />
                                        </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="paid" name="paid" value="{{old('paid')}}" />
                                        </div>
