...
@section('title', 'Pms Invoice Edit')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Edit Pms Invoice</span></h2>
                        ...
                        <div class="md-card">
                            {!! Form::open(['url' => route('pms_invoice_update',$invoice->id), 'method' => 'POST','files' => true]) !!}
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="invoice_date" name="invoice_date" data-uk-datepicker="{format:'YYYY-MM-DD'}" value="{{$invoice->invoice_date}}"/>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <select data-md-selectize name="pms_sites_id" id="pms_sites_id" class="md-input" data-uk-tooltip="{pos:'top'}" title="Select Site">
                                                ...
                                                @foreach($site as $all)
                                                    <option value="{{ $all->id }}" {{ ($all->id==$invoice->pms_sites_id)?'selected':'' }}>{{ $all->company_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <select data-md-selectize name="pms_company_id" id="pms_company_id" class="md-input" data-uk-tooltip="{pos:'top'}" title="Select Employee">
                                                ...
                                                @foreach($company as $all)
                                                    <option value="{{ $all->id }}" {{ ($all->id==$invoice->pms_company_id)?'selected':'' }}>{{ $all->name_en }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-large-1-3 uk-width-medium-1-1">
                                            <div class="uk-input-group">
                                                ...
                                                <input class="md-input invoice_from_date" type="text" id="uk_dp_start" name="invoice_from_date" value="{{ date('d.m.Y' , strtotime($invoice->invoice_from_date)) }}" onchange="fromDate();">
                                        ...
                                        <div class="uk-width-large-1-3 uk-width-medium-1-1">
                                            <div class="uk-input-group">
                                                ...
                                                <input class="md-input invoice_to_date" type="text" id="uk_dp_end" name="invoice_to_date" value="{{ date('d.m.Y' , strtotime($invoice->invoice_to_date)) }}" onchange="toDate();">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-1-4">
                                            ...
                                            <input class="md-input" type="text" id="total_hours" name="total_hours" value="{{$invoice->total_hours}}"/>
                                        ...
                                        <div class="uk-width-medium-1-4">
                                            ...
                                            <input class="md-input" type="text" id="per_hour_rate" name="per_hour_rate" value="{{$invoice->per_hour_rate}}"/>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="number" id="total_amount" name="total_amount" value="{{$invoice->total_amount}}" step="0.01"/>
                                        </div>
