...
@section('title', 'Manpower Vendor Dashboard')
                                ...
                                <div class="md-card" >
                                    ...
                                    <div style="float: left" class="md-fab-wrapper md-fab-in-card md-fab-speed-dial-horizontal">
                                        ...
                                        <div class="md-fab-wrapper-small">
                                            @if(count($order))
                                                <a class="md-fab md-fab-small md-fab-warning" target="_blank" href="{{ route("manpower_Order_total_pdf",[$id,$start,$end]) }}"><i class="material-icons">&#xE415;</i></a>
                                            @endif
                                    ...
                                    @foreach($order as $value)
                                        <tr>
                                            ...
                                            <td class="uk-text-center">
                                                <a href="{!! route('manpower_service_edit',$value->id) !!}" class="batch-edit"><i class="material-icons">&#xE417;</i></a>
                                            </td>
                                        </tr>
