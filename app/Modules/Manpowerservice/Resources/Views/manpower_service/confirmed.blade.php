                                    ...
                                    @foreach($manpower as $value)
                                        <tr>
                                            ...
                                            <td class="uk-text-right" style="white-space:nowrap !important;">
                                                ...
                                                <a href="{{ route('manpower_service_bill_show',['id' => $value->bill_id?$value->bill_id:0,'progress'=>$value->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="material-icons {{$value->bill_id?' md-color-light-green-700': ''}}">B</i></a>
                                                <a href="{{ route('manpower_service_invoice_show',['id' => $value->invoice_id?$value->invoice_id:0,'progress'=>$value->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="material-icons {{$value->invoice_id?' md-color-light-green-700': ''}}">I</i></a>
