                    ...
                    <div class="md-card">
                            ...
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <div class="uk-modal" id="coustom_setting_modal">
                                    <div class="uk-modal-dialog">
                                        {!! Form::open(['url' => route('withdraw_search'), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                        ...
                        <div class="user_content">
                            ...
                            <div class="md-fab-wrapper branch-create">
                                ...
                                $id='Withdrawal';
                                ?>
                                <a id="add_branch_button" href="{{ route('bank_create',$id) }}" class="md-fab md-fab-accent branch-create">
