...
@section('title', 'Kafala before 60 days')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Kafala before 60 days</span></h2>
                            </div>
                        </div>
                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                 ...
                                 @foreach($acknowledgement as $item)
                                     <tr>
                                         ...
                                         <td> {{ !is_null($item["date_of_kafala"])&&!empty($item["date_of_kafala"])?date("Y-m-d",strtotime($item["date_of_kafala"])):'' }}</td>
                                         <td>{{ $item['display_name'] }}</td>
                                         <td style="text-align: center">
                                             <a href="{{ route("iqama_kafala_create",$item["id"]) }}"><i style="font-size: 25px;" class="material-icons">note_add</i> </a>
                                         </td>
                                     </tr>
                                 @endforeach
